      ...
      <div class="hero-container container">
        <div class="hero_detail-box">
          ...
          <div class="hero_btn-continer">
            <a href="{{route ('register.page')}}" class="call_to-btn btn_white-border">
    ...
    <div class="container">
      ...
      <div class="teacher_container layout_padding2">
        ...
        @foreach ($teachers as $teacher)
          <div class="card">
             <img class="card-img-top" src="{{asset('./teacherimg/'.$teacher->pic)}}" >
           
            <div class="card-body">
              <h5 class="card-title">{{$teacher->name}}</h5>
              <h5 class="card-title">{{$teacher->kurs}}</h5>
            </div>
          </div>
          @endforeach
      ...
      <div class="d-flex justify-content-center mt-3">
        <a href="{{route ('teachers')}}" class="call_to-btn  ">
